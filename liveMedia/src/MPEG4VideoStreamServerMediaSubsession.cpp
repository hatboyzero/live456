...
MPEG4VideoStreamServerMediaSubsession::createNew(UsageEnvironment& env,
  ...
  return new MPEG4VideoStreamServerMediaSubsession(env, reuseFirstSource);
}
...
void MPEG4VideoStreamServerMediaSubsession::afterPlayingDummy1() {
...
void MPEG4VideoStreamServerMediaSubsession::checkForAuxSDPLine1() {
...
char const* MPEG4VideoStreamServerMediaSubsession::getAuxSDPLine(RTPSink* rtpSink, FramedSource* inputSource) {
...
FramedSource* MPEG4VideoStreamServerMediaSubsession
::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate) {
  estBitrate = 500; // kbps, estimate

  if (fInputSource != NULL)
  {
      return MPEG4VideoStreamFramer::createNew(envir(), fInputSource);
  }

  return NULL;
}

RTPSink* MPEG4VideoStreamServerMediaSubsession
