...
class LIVEMEDIA_DLL_LINK OnDemandServerMediaSubsession: public ServerMediaSubsession {
...
// want to access it.
class LIVEMEDIA_DLL_LINK Destinations {
public:
...
class LIVEMEDIA_DLL_LINK StreamState {
public:
