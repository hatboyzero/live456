...
class LIVEMEDIA_DLL_LINK H264VideoStreamServerMediaSubsession: public StreamServerMediaSubsession {
public:
...
protected:
    H264VideoStreamServerMediaSubsession(UsageEnvironment& _env, Boolean reuseFirstSource);
